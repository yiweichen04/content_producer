...
from utils import pp, visualize, to_json, test
...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        if FLAGS.is_train:
            ...
            print ('succesful load model')
            test(sess, dcgan, FLAGS, '/home/invigen/wan/course/DL/final_project/SR_samples/samples/00000.jpg')
