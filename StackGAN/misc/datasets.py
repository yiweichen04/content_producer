    ...
    def transform(self, images):
        if self._aug_flag:
            ...
            for i in range(images.shape[0]):
                ...
                #print(i,int(h1),int(w1),self._imsize,'+++++++++++++++++++++++++++++++')
                cropped_image =\
...
class TextDataset(object):
    ...
    def get_data(self, pickle_path, aug_flag=True):
        ...
        with open(pickle_path + self.embedding_filename, 'rb') as f:
            ...
            print('embeddings: ', embeddings.shape)        # print embedding length
        with open(pickle_path + '/filenames.pickle', 'rb') as f:
            list_filenames = pickle.load(f)
            print('list_filenames: ', len(list_filenames), list_filenames[0])     #filenames
